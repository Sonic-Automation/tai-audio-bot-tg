...
def image_watermark(img_response):
    ...
    for offset in range(1, 2):
        ...
        draw.text((x, y - offset), watermark_text, font=font, fill=(88, 88, 88))
    # Applying text on image genai draw object
...
def generate_response_chat(message_list):
    response = openai.ChatCompletion.create(
        ...
        messages=[
                     {"role": "system",
                      "content": "You are an AI named GenAi and you are in a conversation with a human. You can answer "
                                 "questions, provide information, and help with a wide variety of tasks."},
                     {"role": "user", "content": "Who are you?"},
                     {"role": "assistant",
                      "content": "I am the genai powered by ChatGpt.Contact me genai@genaitoken.com"},
                 ] + message_list
    )
...
def generate_response(message_text):
    response = openai.Completion.create(
        ...
        prompt="You are an AI named genai and you are in a conversation with a human. You can answer questions, "
...
def handle_voice(message):
    ...
    space_markup = '                                                                                  '
    image_footer = '[Join GenAI](https://genaitoken.com) | [Website](https://genaitoken.com) | [Buy](' \
                   'https://genaitoken.com)'
    caption = f"Image generated by @{sender_username} using **[GenAI](https://genaitoken.com)" + space_markup + image_footer
